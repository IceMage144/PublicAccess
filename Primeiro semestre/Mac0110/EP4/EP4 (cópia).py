...
#        else:
#            s = int(input("Uma celula sobrevive quando tiver quantos vizinhos (numero de 0 a 8)?\n"))
#            b = int(input("Uma celula nasce quando tiver quantos vizinhos (numero de 0 a 8)?\n"))
...
#        else:
#            s = int(input("Uma celula sobrevive quando tiver quantos vizinhos (numero de 0 a 6)?\n"))
#            b = int(input("Uma celula nasce quando tiver quantos vizinhos (numero de 0 a 6)?\n"))
